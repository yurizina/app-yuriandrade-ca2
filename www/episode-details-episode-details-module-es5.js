...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["episode-details-episode-details-module"], {
  ...
  function srcAppPagesEpisodeDetailsEpisodeDetailsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    "./src/app/services/favourite.service.ts"); //Add the ActivatedRoute, where can be used further in our code to path/navigate 
    ...
    var EpisodeDetailsPage = /*#__PURE__*/function () {
      function EpisodeDetailsPage(activatedRoute, api, favouriteService) {
        ...
        this.api = api;
        this.favouriteService = favouriteService; //Similar to Character details page.ts 

        this.epId = null; //First of all we set the character ID, then we can use the constructor
      ...
      _createClass(EpisodeDetailsPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.api.getEpisode(this.epId).subscribe(function (res) {
            _this.episode = res[0];
            console.log(JSON.stringify(_this.episode.episode_id));
          });
          this.favouriteService.isFav(this.epId).then(function (isFav) {
        ...
        value: function favouriteEp() {
          ...
          this.favouriteService.favouriteEp(this.epId).then(function () {
        ...
        value: function unfavouriteEp() {
          ...
          this.favouriteService.unfavouriteEp(this.epId).then(function () {
