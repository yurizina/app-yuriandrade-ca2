...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-tabs-tabs-module"], {
  ...
  function srcAppPagesTabsTabsRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! ./tabs.page */
    "./src/app/pages/tabs/tabs.page.ts"); // After set up view and main path, we have to set up the rooting for the tabs!  
      ...
      children: [{
        ...
        children: [{
          ...
          loadChildren: function loadChildren() {
            ...
            /*! import() | logo-logo-module */
            "logo-logo-module").then(__webpack_require__.bind(null,
            /*! ../logo/logo.module */
            "./src/app/pages/logo/logo.module.ts")).then(function (m) {
              return m.LogoPageModule;
            });
          }
        }]
      }, {
