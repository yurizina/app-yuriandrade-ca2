    ...
    var EpisodesPage = /*#__PURE__*/function () {
      ...
      _createClass(EpisodesPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.episodes = this.api.getEpisodes(); //Get the data from the funciton getEpisodes

          this.episodes.subscribe(function (data) {
            console.log('my data: ', data); //'my data: ' or 'my data' ? 
          });
        }
      }, {
        key: "openDetails",
        value: function openDetails(episode) {
          ...
          var epId = episode.episode_id; //After we check the episode, we route to the characters details pages! 
